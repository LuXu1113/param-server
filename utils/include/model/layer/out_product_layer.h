#ifndef UTILS_INCLUDE_MODEL_LAYER_OUT_PRODUCT_LAYER_H_
#define UTILS_INCLUDE_MODEL_LAYER_OUT_PRODUCT_LAYER_H_
...
// 实现外积 layer
class OutProductLayer : public Layer {
 public:
...
#endif // UTILS_INCLUDE_MODEL_LAYER_OUT_PRODUCT_LAYER_H_
