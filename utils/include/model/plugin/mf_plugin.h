#ifndef UTILS_INCLUDE_MODEL_PLUGIN_MF_PLUGIN_H_
#define UTILS_INCLUDE_MODEL_PLUGIN_MF_PLUGIN_H_
...
class MFPlugin final : public Plugin {
 public:
...
#endif // UTILS_INCLUDE_MODEL_PLUGIN_MF_PLUGIN_H_
