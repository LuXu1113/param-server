#ifndef UTILS_INCLUDE_MODEL_PLUGIN_WIDE_PLUGIN_H_
#define UTILS_INCLUDE_MODEL_PLUGIN_WIDE_PLUGIN_H_
...
class WidePlugin final : public Plugin {
 public:
...
#endif // UTILS_INCLUDE_MODEL_PLUGIN_WIDE_PLUGIN_H_
