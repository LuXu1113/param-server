#ifndef UTILS_INCLUDE_MODEL_PLUGIN_CVMP_LUGIN_H_
#define UTILS_INCLUDE_MODEL_PLUGIN_CVMP_LUGIN_H_
...
class CVMPlugin final : public Plugin {
 public:
...
#endif // UTILS_INCLUDE_MODEL_PLUGIN_CVM_LUGIN_H_
